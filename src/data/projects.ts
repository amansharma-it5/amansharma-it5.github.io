export type ProjectStatus = 'Live website' | 'Live storefront · ordering unavailable' | 'Functional MVP · pre-release app' | 'In development' | 'Paused';
...
export const projects: Project[] = [
  {
    ...
    filters: ['android'],
    status: 'Functional MVP · pre-release app',
    statusTone: 'amber',
  ...
  },
  {
    ...
    kind: 'browser',
    image: '/assets/images/instafetch-live.jpg',
  ...
  },
  {
    ...
    confidence: 'High — public README and live URL returned HTTP 200',
    kind: 'browser',
    image: '/assets/images/recruitos-ai-live.jpg',
  ...
  },
  {
    ...
    status: 'Live storefront · ordering unavailable',
    statusTone: 'amber',
    ...
    confidence: 'High — public README and live URL returned HTTP 200',
    kind: 'catalogue',
    image: '/assets/images/frost-flowers-live.jpg',
